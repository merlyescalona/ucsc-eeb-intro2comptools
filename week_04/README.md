...
https://www.dropbox.com/sh/1p07a2qr413n0c5/AABmLPdYsdnbVfen74cYKTUma?dl=0
...
Knowing that you can analyze raw sequencing data (FASTQ files) with the command `fastqc -o fastqc_out *.fastq*`, create a SLURM file to analyze the `.fastq` files provided in the following link:
